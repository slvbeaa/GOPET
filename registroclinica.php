...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="registroclinica.css">
...
<body> 
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-YvpcrYf0tY3lHB60NNkmXc5s9fDVZLESaAA55NDzOxhy9GkcIdslK1eN7N6jIeHz" crossorigin="anonymous"></script>
    ...
    <nav class="navbar" style="background-color: #0DA0C0;">
    ...
    <div class="card mb-3" style="max-width: 620px;">
        <div class="row g-0">
          ...
          <div class="col-md-8">
            <div class="card-body">
              ...
              <a href="registro1.html"><button class="btn" style="background-color: #10b8dd;">Editar</button></a>
              <button class="btn" style="background-color: #10b8dd;">Excluir</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card mb-3" style="max-width: 620px;">
        <div class="row g-0">
          <div class="col-md-4">
            <img src="img2.jpg" class="img-fluid rounded-start" alt="...">
          </div>
          <div class="col-md-8">
            <div class="card-body">
      ...
      <div class="card mb-3" style="max-width: 620px;">
        <div class="row g-0">
          <div class="col-md-4">
            <img src="img9.jpg" class="img-fluid rounded-start" alt="...">
          </div>
          <div class="col-md-8">
            <div class="card-body">
              <h5 class="card-title text-center">TESTE</h5>
              <p class="card-text text-center">24hrs</p>
              <p class="card-text text-center">Email: teste@gmail.com</p>
              <p class="card-text text-center">Contato: 0000-0000</p> 
              <a href="registro1.html"><button class="btn" style="background-color: #10b8dd;">Editar</button></a>
              <button class="btn" style="background-color: #10b8dd;">Excluir</button>
            </div>
          </div>
      ...
      <div class="d-grid gap-2 col-2 mx-auto">
        <button class="btn" style="background-color: #10b8dd;">Cadastrar Clínica</button>
      </div>
